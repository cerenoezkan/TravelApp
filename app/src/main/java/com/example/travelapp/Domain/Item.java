...
public class Item implements Serializable {
    ...
    private String getTourGuideName;
    private String tourGuidePhone;
    private String getTourGuidePic;
    private int price;
    private int bed;
    ...
    public String getGetTourGuideName() {
        return getTourGuideName;
    }

    public void setGetTourGuideName(String getTourGuideName) {
        this.getTourGuideName = getTourGuideName;
    }
    ...
    public String getGetTourGuidePic() {
        return getTourGuidePic;
    }

    public void setGetTourGuidePic(String getTourGuidePic) {
        this.getTourGuidePic = getTourGuidePic;
    }
